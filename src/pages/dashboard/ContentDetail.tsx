...
const INTENTS: Array<{ id: ContentIntent; label: string; desc: string }> = [
  { id: "educate", label: "Educate", desc: "In-depth educational article" },
  { id: "compare", label: "Compare", desc: "X vs Y comparison" },
  { id: "faq", label: "FAQ", desc: "Questions & answers format" },
  { id: "define", label: "Define", desc: "Entity / definition page" },
  { id: "guide", label: "How-To Guide", desc: "Step-by-step guide" },
  { id: "rank", label: "Best-of List", desc: "Top N tools / options" },
];
...
${category} has become a critical discipline as AI systems increasingly shape how people discover products, services, and information. In this ${intent === "educate" ? "guide" : intent === "compare" ? "comparison" : "overview"}, we cover everything you need to know.
...
export default function ContentDetailPage() {
  ...
  // Generate state
  const [intent, setIntent] = useState<ContentIntent>("educate");
